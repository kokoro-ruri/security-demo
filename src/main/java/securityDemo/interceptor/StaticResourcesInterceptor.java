package securityDemo.interceptor;
...
/**
 * @Package: securityDemo.interceptor
 * @ClassName: StaticResourcesInterceptor
 * @Description:
 * @UpdateDate: 2020/5/25 17:11
 */
public class StaticResourcesInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        String fileName = URLDecoder.decode(uri.substring(uri.lastIndexOf("/") + 1), "UTF-8");
